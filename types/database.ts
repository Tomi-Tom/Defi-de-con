  ...
  public: {
    Tables: {
      ...
      participant_adjustments: {
        ...
        Insert: Omit<Database['public']['Tables']['participant_adjustments']['Row'], 'id' | 'created_at'> & { id?: string; created_at?: string }
        Update: Partial<Database['public']['Tables']['participant_adjustments']['Insert']>
        Relationships: []
      }
    }
